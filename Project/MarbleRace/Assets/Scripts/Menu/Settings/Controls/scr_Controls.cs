...
public class scr_Controls : MonoBehaviour {
    ...
    string GetLine(string inputName)
    {
        ...
        GameObject childPos = GameObject.Find(inputName).transform.Find("NamePos").gameObject;
        ...
        {
            line += childPos.transform.Find(inputStr + "1").Find("Text").GetComponent<Text>().text + ",";
            line += childPos.transform.Find(inputStr + "2").Find("Text").GetComponent<Text>().text + ",";
        }
        else
        {
            line += "null,null,";
        ...
        GameObject childNeg = GameObject.Find(inputName).transform.Find("NameNeg").gameObject;
        inputStr = "Input";
        switch (inputName)
        {
            case "Start":
        ...
        {
            line += childNeg.transform.Find(inputStr + "1").Find("Text").GetComponent<Text>().text + ",";
            line += childNeg.transform.Find(inputStr + "2").Find("Text").GetComponent<Text>().text;
        }
        else
        {
            line += "null,null";
